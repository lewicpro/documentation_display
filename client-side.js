        ...
        for (let namespace in groupedFunctions) {
            ...
            if (groupedFunctions[namespace].length > 1) {
                ...
                groupedFunctions[namespace].forEach(function(item) {
                    ...
                    subA.setAttribute("data-file", item.FileName);
...
function getData(event) {
    ...
    var filegiven = event.target.getAttribute("data-file");
    ...
    fetch("details.html")
        ...
        .then(data => {
            ...
            if(method==''){
                methodd.innerHTML='No data'
            }else{
                methodd.innerHTML = method;
        
            }
            if(returns==''){
                returned.innerHTML='No data'
            }else{
                returned.innerHTML = returns;
        
            }
            if(rest==''){
                restd.innerHTML='No data'
            }else{
                restd.innerHTML = rest;
        
            }
            if(description===''){
                descriptiond.innerHTML='No data'
            }else{
                descriptiond.innerHTML = description;
        
            }
            if(functiongiven===''){
                functiond.innerHTML='No data'
            }
            else{
                functiond.innerHTML = functiongiven;
        
            }
            filename.innerHTML = filegiven;
...
function getHiglight(event) {
    ...
    if(method===''){
        highlight_method.innerHTML='No data'
    }else{
    ...
    if(returns==''){
        highlight_return.innerHTML='No data'
    }else{
        highlight_return.innerHTML='- '+returns

    }
    if(rest==''){
        highlight_rest.innerHTML='No data'
    }else{
        highlight_rest.innerHTML='- '+rest

    }
    if(description===''){
        highlight_description.innerHTML='No data'
    }else{
        highlight_description.innerHTML='- '+description

    }
    if(functiongiven===''){
        highlight_function.innerHTML='No data'
    }
    else{
